...
<div class="block-header">
	<ol class="breadcrumb breadcrumb-col-cyan">
		...
		<li><a href="<?php echo base_url(); ?>panel/slayt_yonetim/"><i class="material-icons">collections</i> Slide Listesi</a></li>
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="card">
			...
			<div class="body">
				...
				<form action="<?php echo base_url("panel/slayt_yonetim/slayt_ekle") ?>" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
					<div class="form-group">
						<div class="form-line"> 
							<label class="control-label" >Slide Başlık</label> 
							<input type="text" class="form-control" name="slaytBaslik" placeholder="örn:resim1" required=""> 
						</div>
					</div>
					<div class="form-group">
						<div class="form-line"> 
							<label class="control-label" >Slide Başlık En</label> 
							<input type="text" class="form-control" name="slaytBaslik_en" placeholder="örn:resim1" required=""> 
						</div>
					</div>
					<div class="form-group"> 
						<label class="control-label">Slayt Resmi Seçiniz</label> 

						<input id="slayt" name="slaytResim" style="display: none;">
						<div class="kv-avatar" style="width:200px">
							<div class="file-input">
								<div class="file-preview-frame">
									<img id="slayt" src="<?php echo base_url("public/admin/uploads/img_upload.png") ?>" style="width: 200px;height: 200px;">
								</div>
							</div>
						</div>
