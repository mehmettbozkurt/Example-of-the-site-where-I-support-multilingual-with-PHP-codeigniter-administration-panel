...
<div class="block-header">
    <ol class="breadcrumb breadcrumb-col-cyan">
	    ...
	    <li class="active"><i class="material-icons">edit</i>Marka Düzenle</a></li>
	</ol>
</div>
...
<div class="row clearfix">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
			...
			<form action="<?php echo base_url("panel/marka_yonetim/marka_guncelle/$marka->markaId") ?>" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
			
					<div class="form-group">
					 	<div class="form-line"> 
							<label class="control-label" >Marka Ad</label> 
							<input type="text" class="form-control" name="markaAd" value="<?php echo $marka->markaAd ?>" placeholder="örn:SMarka Adı" required=""> 
						</div>
					</div>
					<div class="form-group">
					 	<div class="form-line"> 
							<label class="control-label" >Marka Sıra</label> 
							<input type="number" class="form-control" name="markaSira" placeholder="örn:1" required="" value="<?php echo $marka->markaSira ?>"> 
						</div>
					</div>
					<div class="form-group">
					 	<div class="form-line"> 
							<label class="control-label" >Marka Link</label> 
							<input type="text" class="form-control" name="markaLink" value="<?php echo $marka->markaLink ?>" placeholder="örn:<?php echo base_url() ?>" required=""> 
						</div>
					</div>
					

					<div class="form-group"> 
						<label class="control-label">Marka Resmi Seçiniz</label> 

				        <input id="marka" name="markaResim" style="display: none;" value="<?php echo $marka->markaResim ?>">
			         	<div class="kv-avatar" style="width:200px">
			         		<div class="file-input">
			         			<div class="file-preview-frame">
				       				<img id="markaResim" src="<?php echo base_url("public/admin/uploads/markalar/$marka->markaResim") ?>" style="width: 200px;height: 200px;" onerror="this.src='<?php echo base_url("public/admin/uploads/img_upload.png") ?>'" >
				       			</div>
				       		</div>
				       	</div>
